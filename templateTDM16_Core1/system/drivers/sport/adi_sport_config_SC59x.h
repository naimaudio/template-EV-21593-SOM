...
#define ADI_SPORT_STATIC_INSTANCES                   16
 ...
 *  	for (slen <= 15 bits) and (DMA packing is enabled) -----> MSIZE = 4 Bytes.
 ...
 *  	for (slen <= 15 bits) and (DMA packing is enabled) -----> PSIZE = 4 Bytes.
